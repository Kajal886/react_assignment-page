      ...
      <div className='Mid_div'>
        ...
        {product.map((val) => (
         ...
         <div className='product_div'>
                 <img src={val.image} className='first_img'/> 
                 
                 <figcaption className='jacket'>{val.title}</figcaption>
                 <p className='text'>{val.description}</p>
                 <label className='price'>${val.price}</label></div>
               </>
              ))}
        </div>
...
Get news about articles and updates in your inbox.</p>
          ...
          <div className='form_Div'>
            <p className='headings'>NAME</p><hr className='f_line'></hr> <p className='headings'>EMAIL</p><hr className='f_line'></hr> <p className='headings'>MESSAGE</p><hr className='f_line'></hr>
          </div>
       
        </div>
       <div>
       <h1 className='big_head'>GET <br></br>IN TOUCH</h1>
